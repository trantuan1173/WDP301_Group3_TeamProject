...
const AdminManageClass = () => {
  ...
  const months = getAllMonths(classes);
      ...
      <div className="flex justify-between items-center mt-4 px-2">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1 rounded font-normal ${currentPage === 1 ? "bg-gray-200 cursor-not-allowed" : "bg-blue-500 text-white"}`}
          >
            Prev
          </button>
          <button
            ...
            className={`px-3 py-1 rounded font-normal ${currentPage === totalPages ? "bg-gray-200 cursor-not-allowed" : "bg-blue-500 text-white"}`}
          >
            Next
          </button>
        </div>
