...
import {
  FaChevronDown, FaChevronUp, FaPlus, FaUserPlus, FaCalendarAlt,
  FaArrowLeft, FaExchangeAlt, FaUsers, FaUserTie, FaChalkboardTeacher,
  FaClock, FaBookOpen, FaCalendar, FaSignal
} from "react-icons/fa";
...
export default function AdminViewClassDetails() {
  ...
  const handleBack = () => {
    if (from === 'classes') {
      navigate('/admin/classes', { state: { selectedPage: 'classes' } });
    } else {
      navigate('/admin');
    }
  };
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          ...
          <div className="bg-white rounded-xl shadow p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-12 text-[15px]">
              ...
              <div className="text-gray-500 flex items-center gap-2">
                <FaChalkboardTeacher /> Class Name:
              </div>
