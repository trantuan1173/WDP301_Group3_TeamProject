...
export default function UserProfileForm() {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    // Kiểm tra định dạng số điện thoại và ngày sinh
    ...
    try {
      ...
      const response = await axios.put(
        API_ENDPOINTS.USER_UPDATE_PROFILE(userId),
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                value={profile?.profileData?.address}
                placeholder="Address"
                disabled={!isEditing}
                onChange={(e) =>
                  setProfile({
